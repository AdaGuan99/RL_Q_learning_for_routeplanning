...
def update(order):
    ...
    for episode in range(600):  # 进行一百个回合
        ...
        done1 = 0
        done2 = 0
        QLearningTable.center = [observation1, observation2]
...
if __name__ == "__main__":
    ...
    for i in range(1, 2):
        env = Maze()
        RL1 = QLearningTable(actions=env.action_space, number=1, order=i)
        RL2 = QLearningTable(actions=env.action_space, number=2, order=i)
